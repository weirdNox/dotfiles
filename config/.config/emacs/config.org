...
(use-package jai-mode :elpaca (jai-mode :host github :repo "weirdNox/jai-mode"
  ...
  (after! dumb-jump
    ...
    (add-to-list 'dumb-jump-find-rules
                 '(:type "constant" :supports ("ag" "rg") :language "jai"
                         :regex "\\bJJJ\\s*::"))))
#+end_src
...
(use-package python
  ...
  (after! dumb-jump
    (add-to-list 'dumb-jump-find-rules
                 '(:type "assignment" :supports ("ag" "rg") :language "python"
                         :regex "\\bJJJ\\s*=[^=\\n]"))
    (add-to-list 'dumb-jump-find-rules
                 '(:type "function" :supports ("ag" "rg") :language "python"
                         :regex "def\\s+JJJ\\b\\s*\\("))
    (add-to-list 'dumb-jump-find-rules
                 '(:type "type" :supports ("ag" "rg") :language "python"
