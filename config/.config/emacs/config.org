...
(defvar nox-fonts '(("PragmataPro"      10.0 .00)
                    ...
                    ("Iosevka"          10.0 .00)
                    ("Monaspace Neon"   10.0 .00)
                    ("Monaspace Argon"  10.0 .00)
                    ("Monaspace Xenon"  10.0 .00)))
...
#+BEGIN_SRC emacs-lisp
(defface font-lock-nocheckin-face '((t (:foreground "#dc322f" :weight bold :box t)))
  "Face for nocheckin keywords.")
...
(add-hook! prog-mode (font-lock-add-keywords
                      nil '(("\\<\\(nocheckin\\)" 1 'font-lock-nocheckin-face t)
                            ("\\<\\(TODO\\|FIXME\\|OPTIMIZE\\|HACK\\)" 1 'font-lock-todo-face t)
  ...
  (c-add-style c-default-style
               '((c-basic-offset . 4)
                 (c-offsets-alist . ((case-label . +)
                                     ...
                                     (statement-cont . (c-lineup-ternary-bodies 0))
