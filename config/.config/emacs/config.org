...
(use-package consult :straight t
  ...
  (setq! consult-ripgrep-command
         ...
         consult-project-root-function nil)
...
(use-package ctrlf :straight t
  ...
  (:keymaps 'ctrlf-mode-map
            [remap isearch-forward]         nil
            [remap isearch-backward]        nil
            [remap isearch-forward-regexp]  nil
            [remap isearch-backward-regexp] nil

            "C-S-s"   #'isearch-forward
            "C-S-r"   #'isearch-backward
            "C-M-S-s" #'isearch-forward-regexp
            "C-M-S-r" #'isearch-backward-regexp
