...
(add-hook 'elpaca-after-init-hook #'nox|setup-switch-hooks)
#+END_SRC
...
**** Highlight line
#+BEGIN_SRC emacs-lisp
(use-package hl-line :elpaca nil :init (global-hl-line-mode 1))
#+END_SRC
...
#+begin_src emacs-lisp
(use-package company)
(use-package company-dabbrev :elpaca nil
  :config
...
*** Electric
#+BEGIN_SRC emacs-lisp
(use-package electric :elpaca nil
...
*** Assembly
#+begin_src emacs-lisp
(use-package asm-mode :elpaca nil
  :config
...
*** (Ba)sh
#+begin_src emacs-lisp
(use-package sh-mode :elpaca nil
  :init (add-to-list 'major-mode-remap-alist '(sh-mode . bash-ts-mode)))
#+end_src

*** C/C++
#+BEGIN_SRC emacs-lisp
(use-package c-ts-mode :elpaca nil
  ...
  (defun c-ts--nox-indent-style ()
    `((c-ts-mode--for-each-tail-body-matcher prev-line c-ts-mode-indent-offset)
      ...
      ;; Top-level things under a preproc directive.
      ;; Note that "preproc" matches more than one type: it matches preproc_if, preproc_elif, etc.
      ...
      ;; Statement in {} blocks.
      ((parent-is "compound_statement") standalone-parent-or-uncle c-ts-mode-indent-offset)
      ;; Opening bracket.
      ...
      ((parent-is "for_statement") (nth-sibling 1) 1)
      ((parent-is "case_statement") standalone-parent c-ts-mode-indent-offset)

      ((node-is "field_initializer_list") parent-bol ,(* c-ts-mode-indent-offset 2))))
  (setq! c-ts-mode-indent-style #'c-ts--nox-indent-style))
#+END_SRC

*** Dockerfile & Containerfile
#+begin_src emacs-lisp
(use-package dockerfile-ts-mode :elpaca nil
...
(use-package jai-mode :elpaca (jai-mode :host github :repo "weirdNox/jai-mode"
  ...
  (after! dumb-jump
    ...
    (add-to-list 'dumb-jump-find-rules
                 '(:type "constant" :supports ("ag" "grep" "rg" "git-grep") :language "jai" :regex "JJJ\\s+::"))))
#+end_src
...
(use-package matlab-shell :elpaca nil
  :config
...
*** MIPS
#+BEGIN_SRC emacs-lisp
(use-package mips-mode :elpaca nil
  :config
...
*** SPICE
#+begin_src emacs-lisp
(use-package spice-mode :elpaca nil
  :mode (("\\.sp\\'"  . spice-mode)
         ("\\.cir\\'" . spice-mode)
         ("\\.cdl\\'" . spice-mode)
         ("\\.chi\\'" . spice-mode)
...
*** Verilog & VHDL
#+begin_src emacs-lisp
(use-package verilog-mode :elpaca nil
  :config
...
(use-package vhdl-mode :elpaca nil
  :config
  ;; NOTE(nox): Prevent cluttering compilation regexp alist
...
**** Archiving
#+begin_src emacs-lisp
(use-package org-archive :elpaca nil
  :config
...
***** MATLAB & Octave
#+BEGIN_SRC emacs-lisp
(use-package ob-octave :elpaca nil
  :config
...
#+BEGIN_SRC emacs-lisp
(use-package org-list :elpaca nil
  :config
...
(use-package org-element :elpaca nil :commands org-element-update-syntax)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(use-package org-agenda :elpaca nil
  :general
...
*** Attach
#+BEGIN_SRC emacs-lisp
(use-package org-attach :elpaca nil
  :config
...
#+BEGIN_SRC emacs-lisp
(use-package org-protocol :elpaca nil :commands org-protocol-check-filename-for-protocol)

(use-package org-capture :elpaca nil
...
*** Clocking
#+BEGIN_SRC emacs-lisp
(use-package org-clock :elpaca nil
  :config
...
*** Element
#+begin_src emacs-lisp
(use-package org-element :elpaca nil
  :config
...
*** Habit
#+BEGIN_SRC emacs-lisp
(use-package org-habit :elpaca nil
  :config
...
*** Persist
#+begin_src emacs-lisp
(use-package org-persist :elpaca nil
  :config
...
*** Source blocks
#+BEGIN_SRC emacs-lisp
(use-package org-src :elpaca nil
  :config
...
*** CMake
#+begin_src emacs-lisp
(use-package cmake-ts-mode :elpaca nil
...
**** Doc View
#+BEGIN_SRC emacs-lisp
(use-package doc-view :elpaca nil
  :config
...
(use-package pdf-annot :elpaca nil :config (setq! pdf-annot-tweak-tooltips nil))
(use-package pdf-cache :elpaca nil :config (setq! pdf-cache-image-limit 200))
(use-package pdf-view :elpaca nil
  :config
...
**** Apropos
#+BEGIN_SRC emacs-lisp
(use-package apropos :elpaca nil
  :config
...
#+BEGIN_SRC emacs-lisp
(use-package calendar :elpaca nil
  :config
...
(use-package holidays :elpaca nil
  :config
