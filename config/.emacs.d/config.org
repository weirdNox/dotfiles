  ...
  (let ((buffer-file-name (or buffer-file-name ""))
    ...
    (propertize
     (pcase +modeline-buffer-file-name-style
       (`truncate-upto-project (+modeline--buffer-file-name 'shrink))
       (`truncate-upto-root (+modeline--buffer-file-name-truncate))
       (`truncate-all (+modeline--buffer-file-name-truncate t))
       (`relative-to-project (+modeline--buffer-file-name-relative))
       (`relative-from-project (+modeline--buffer-file-name-relative 'include-project))
...
(defun +modeline--buffer-file-name-truncate (&optional truncate-tail)
...
(defun +modeline--buffer-file-name-relative (&optional include-project)
...
(defun +modeline--buffer-file-name (truncate-project-root-parent)
