...
**** Latex
#+BEGIN_SRC emacs-lisp
(defun +org-compile-latex (source)
  (shell-command (concat "latexmk "
                         (cond ((string= org-latex-compiler "xelatex") "-xelatex ")
                               ((string= org-latex-compiler "lualatex") "-lualatex ")
                               (t "-pdf "))
                         source)))

(setq!
 org-latex-pdf-process #'+org-compile-latex
