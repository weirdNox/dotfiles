    ...
    (cl-letf* (((symbol-function #'org-babel-strip-quotes) 'identity)
               ((symbol-function #'org-trim)
                (lambda (string)
                  (cond
                   (matlabp
                    (setq string (string-trim-right (replace-regexp-in-string "\\`[^\n]*\n*" "" string)
                                                    "\n"))
...
(use-package org-agenda
  ...
  (defun +agenda|skip-deadline-prewarning-if-deadline-is-visible ()
  ...
  (setq!
   ...
   '(("n" "Agenda"
      ((agenda "" ((org-agenda-span 3)
                   ...
                   (org-agenda-skip-function #'+agenda|skip-deadline-prewarning-if-deadline-is-visible)))
